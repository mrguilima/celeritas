...
void MagFieldPropagator::apply_linear_step(real_type step)
{
 ...
 */
CELER_FORCEINLINE_FUNCTION
void MagFieldPropagator::operator()()
{
 ...
 */
CELER_FORCEINLINE_FUNCTION
void MagFieldPropagator::operator()(real_type dist)
{
    REQUIRE(dist > 0.);
