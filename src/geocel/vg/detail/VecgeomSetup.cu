...
{
    using pointer_type = VECGEOM_PRECISION_NAMESPACE::NavIndex_t const*;
 ...
 * Get pointers to the device BVH after setup, for consistency checking.
 */
CudaPointers<VECGEOM_PRECISION_NAMESPACE::NavIndex_t const> navindex_pointers_device()
{
    CudaPointers<VECGEOM_PRECISION_NAMESPACE::NavIndex_t const> result;
