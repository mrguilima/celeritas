...
//---------------------------------------------------------------------------//
//! \file MagFieldPropagator.test.cc
//---------------------------------------------------------------------------//
...
class MagFieldPropagatorHostTest : public GeoParamsTest
{
  public:
...
TEST_F(MagFieldPropagatorHostTest, accessors)
{
...
TEST_F(MagFieldPropagatorHostTest, track_line)
{
    GeoTrackView     geo(params_view, state_view, ThreadId(0));
    //ParticleTrackView particle
    MagFieldPropagator propagate(geo); // one propagator per track
...
TEST_F(MagFieldPropagatorHostTest, track_intraVolume)
{
    GeoTrackView     geo(params_view, state_view, ThreadId(0));
    MagFieldPropagator propagate(geo); // one propagator per track
...
class MagFieldPropagatorDeviceTest : public GeoParamsTest
{
};

TEST_F(MagFieldPropagatorDeviceTest, track_lines)
{
    CHECK(this->params());
